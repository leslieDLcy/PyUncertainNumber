...
from pyuncertainnumber.SA.Sobol_analysis import sobol_analysis
...
# 3. Run the analysis
results = sobol_analysis(inputs, my_model,calc_second_order=True, print_to_console = True, N=512)
