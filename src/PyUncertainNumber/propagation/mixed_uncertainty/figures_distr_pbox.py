...
def plot_interval(lower_bound, upper_bound, color='blue', label=None):
  ...
  plt.plot([lower_bound, upper_bound], [1, 1], color=color, linewidth=2, label=label)  # Plot the interval line
  plt.plot([lower_bound, lower_bound], [0, 1], color=color, linewidth=2, label=label)  # Plot the interval line
  plt.plot([upper_bound, upper_bound], [0, 1], color=color, linewidth=2, label=label)  # Plot the interval line
